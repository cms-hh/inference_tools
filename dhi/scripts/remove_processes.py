...
if __name__ == "__main__":
    ...
    parser.add_argument("names", nargs="+", metavar="NAME", help="names of processes or files "
        "containing process names to remove line by line; supports patterns; prepending '!' to a "
