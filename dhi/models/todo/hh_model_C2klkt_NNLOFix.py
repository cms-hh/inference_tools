...
from dhi.models.hh_model_NNLOFix import (
...
# using WG4 recommendation, calculated from coefficients in 2304.01968
ggf_samples = OrderedDict()
add_ggf_sample = _create_add_sample_func(GGFSample, ggf_samples)
add_ggf_sample(kl=0.0, kt=1.0, C2=0.0, xs=0.06918, label="ggHH_kl_0p00_kt_1p00_c2_0p00")
add_ggf_sample(kl=1.0, kt=1.0, C2=0.0, xs=0.0310356, label="ggHH_kl_1p00_kt_1p00_c2_0p00")
add_ggf_sample(kl=2.45, kt=1.0, C2=0.0, xs=0.0135909, label="ggHH_kl_2p45_kt_1p00_c2_0p00")
add_ggf_sample(kl=5.0, kt=1.0, C2=0.0, xs=0.09163, label="ggHH_kl_5p00_kt_1p00_c2_0p00")
add_ggf_sample(kl=0.0, kt=1.0, C2=1.0, xs=0.1329618, label="ggHH_kl_0p00_kt_1p00_c2_1p00")
add_ggf_sample(kl=1.0, kt=1.0, C2=0.1, xs=0.0161258, label="ggHH_kl_1p00_kt_1p00_c2_0p10")
add_ggf_sample(kl=1.0, kt=1.0, C2=0.35, xs=0.009461, label="ggHH_kl_1p00_kt_1p00_c2_0p35")
add_ggf_sample(kl=1.0, kt=1.0, C2=3.0, xs=2.6265573, label="ggHH_kl_1p00_kt_1p00_c2_3p00")
add_ggf_sample(kl=1.0, kt=1.0, C2=-2.0, xs=1.7980721, label="ggHH_kl_1p00_kt_1p00_c2_m2p00")
