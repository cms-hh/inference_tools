...
from dhi.models.hh_model_NNLOFix import (  # noqa
...
add_boosted_ggf_sample(kl=0.0, kt=1.0, xs=0.06918, label="boosted_ggHH_kl_0_kt_1")
add_boosted_ggf_sample(kl=1.0, kt=1.0, xs=0.0310356, label="boosted_ggHH_kl_1_kt_1")
add_boosted_ggf_sample(kl=2.45, kt=1.0, xs=0.0135909, label="boosted_ggHH_kl_2p45_kt_1")
add_boosted_ggf_sample(kl=5.0, kt=1.0, xs=0.09163, label="boosted_ggHH_kl_5_kt_1")
# additional base points for stabilizing signal pdfs
add_boosted_ggf_sample(kl=-10.0, kt=1.0, xs=1.62307, label="boosted_ggHH_kl_m10_kt_1")
add_boosted_ggf_sample(kl=20.0, kt=1.0, xs=3.35656, label="boosted_ggHH_kl_20_kt_1")
add_boosted_ggf_sample(kl=-15.0, kt=1.0, xs=3.19941, label="boosted_ggHH_kl_m15_kt_1")
add_boosted_ggf_sample(kl=25.0, kt=1.0, xs=5.51073, label="boosted_ggHH_kl_25_kt_1")
add_boosted_ggf_sample(kl=-3.0, kt=1.0, xs=0.3115164, label="boosted_ggHH_kl_m3_kt_1")
