...
add_ggf_sample(kl=0.0, kt=1.0,  xs=0.07643, label="ggHH_kl_0_kt_1")
add_ggf_sample(kl=1.0, kt=1.0,  xs=0.03443, label="ggHH_kl_1_kt_1")
add_ggf_sample(kl=2.45, kt=1.0, xs=0.01505, label="ggHH_kl_2p45_kt_1")
add_ggf_sample(kl=5.0, kt=1.0,  xs=0.1005,  label="ggHH_kl_5_kt_1")
...
# It is useless at 13.6 TeV as all input ggHH samples should be normalized to NNLO XS's  
# For the moment leaving it fixed to unity cause it's too much work removing it
ggf_k_factor = 1.0 
...
ggf_kl_coeffs = {
    ...
    "nlo":  (76.4346, -53.7587, 11.7158),
    "nnlo": (76.4346, -53.7587, 11.7158),
    # QCDscale + mtop uncertainty coefficients (max/min to be taken from 1 and 2)
    "unc_u1": (84.1303, -61.5633, 13.8114),
    "unc_u2": (84.1303, -61.5633, 13.8114),
    "unc_d1": (62.9873, -46.5956, 10.3251),
    "unc_d2": (62.9873, -46.5956, 10.3251),
}
