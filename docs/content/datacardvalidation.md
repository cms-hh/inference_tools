...
Check task status:
```shell
law run ValidateDatacard --input-card /afs/cern.ch/user/m/mfackeld/public/datacards/ee_tight/datacard.txt --mass 125 --print-status 0
```
Output:
```shell
print task status with max_depth 0 and target_depth 0

> check status of ValidateDatacard(mass=125, input_card=/afs/cern.ch/user/m/mfackeld/public/datacards/ee_tight/datacard.txt, verbosity=1)
...
Run validation:
```shell
law run ValidateDatacard --input-card /afs/cern.ch/user/m/mfackeld/public/datacards/ee_tight/datacard.txt --mass 125
```
Output:
```shell
INFO: Informed scheduler that task   ValidateDatacard__afs_cern_ch_use_125_1_de72c0d5bd   has status   PENDING
INFO: Done scheduling tasks
INFO: Running Worker with 1 processes
INFO: [pid 19954] Worker Worker(salt=161905714, workers=1, host=lxplus7112.cern.ch, username=<username>, pid=19954) running   ValidateDatacard(mass=125, input_card=/afs/cern.ch/user/m/mfackeld/public/datacards/ee_tight/datacard.txt, verbosity=1)
...
INFO: [pid 19954] Worker Worker(salt=161905714, workers=1, host=lxplus7112.cern.ch, username=<username>, pid=19954) done      ValidateDatacard(mass=125, input_card=/afs/cern.ch/user/m/mfackeld/public/datacards/ee_tight/datacard.txt, verbosity=1)
INFO: Informed scheduler that task   ValidateDatacard__afs_cern_ch_use_125_1_de72c0d5bd   has status   DONE
