...
setup() {
    ...
    export DHI_EXAMPLE_CARDS_EFT_BM="$( echo /eos/user/m/mrieger/dhi/example_cards/eft_benchmarks/fake/datacard_*.txt | sed 's/ /,/g' )"
    export DHI_EXAMPLE_CARDS_EFT_C2="$( echo /eos/user/m/mrieger/dhi/example_cards/eft_c2_scan/fake/datacard_c2_*.txt | sed 's/ /,/g' )"
