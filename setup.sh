...
setup() {
    ...
    # export DHI_COMBINE_VERSION_SEMVER="${DHI_COMBINE_VERSION_SEMVER:-${DHI_COMBINE_VERSION}}"
    export DHI_SCRAM_ARCH="${DHI_SCRAM_ARCH:-el9_amd64_gcc12}"
    export DHI_CMSSW_VERSION="${DHI_CMSSW_VERSION:-CMSSW_14_0_0_pre1}"
    export DHI_COMBINE_VERSION="${DHI_COMBINE_VERSION:-main}"
    export DHI_COMBINE_VERSION_SEMVER="${DHI_COMBINE_VERSION_SEMVER:-v9.1.0}"
